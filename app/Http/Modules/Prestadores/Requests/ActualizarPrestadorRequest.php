...
class ActualizarPrestadorRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'nombre_prestador'      => "required|string|max:255|unique:prestadores,nombre_prestador," . $this->prestador->id . ',id',
            'municipio_id'          => "required|exists:municipios,id",
            'nit'                   => "required|string|max:255",
            'razon_social'          => "required|string|max:255|unique:prestadores,razon_social," . $this->prestador->id . ',id',
            ...
            'codigo_habilitacion'   => "required|string|max:255",
