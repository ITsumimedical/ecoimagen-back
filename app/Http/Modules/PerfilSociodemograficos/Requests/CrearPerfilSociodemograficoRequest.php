...
class CrearPerfilSociodemograficoRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'tiene_mascota' => 'nullable|boolean',
