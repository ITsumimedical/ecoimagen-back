...
class CrearComponenteHistoriaRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'nombre' => 'required|string|unique:componentes_historia_clinicas,nombre',
            'ruta' => 'required|string|unique:componentes_historia_clinicas,ruta',
