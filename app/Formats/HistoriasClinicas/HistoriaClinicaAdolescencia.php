...
class HistoriaClinicaAdolescencia extends Fpdf
{
    protected static $consulta;

    public function bodyAdolescencia($pdf, $consulta)
    {
        ...
        $pdf->SetFillColor(214, 214, 214);
        $pdf->SetTextColor(0, 0, 0);
        $pdf->Cell(186, 6, utf8_decode('ANTECEDENTES HOSPITALARIOS'), 1, 0, 'C', 1);
        $pdf->Ln();
        ...
        if ($antecedentesHospitalarios->isEmpty()) {
            $pdf->SetX(12);
            $pdf->Cell(186, 6, utf8_decode('No refiere'), 1, 0, 'L');
            $pdf->Ln();
        } else {
            $contador = 1;
        ...
        if (self::$consulta["afiliado"]["sexo"] == 'F' && self::$consulta["afiliado"]["edad_cumplida"] >= 13 && self::$consulta["afiliado"]["edad_cumplida"] <= 50) {
            ...
            $pdf->SetFillColor(214, 214, 214);
            $pdf->SetTextColor(0, 0, 0);
            $pdf->Cell(186, 4, utf8_decode('ANTECEDENTES GINECOSTETRICOS'), 1, 0, 'C', 1);
            $pdf->Ln();
            $pdf->SetTextColor(0, 0, 0);
            $pdf->SetDrawColor(0, 0, 0);
            $pdf->SetFont('Arial', '', 8);

            $presenteMenarquia = isset(self::$consulta["HistoriaClinica"]["presente_menarquia"]) ? self::$consulta["HistoriaClinica"]["presente_menarquia"] : 'No Reporta';

            // Verificamos si la menarquia es "Si" y agregamos la edad en ese caso
            if ($presenteMenarquia === 'Si') {
                $edadMenarquia = isset(self::$consulta["HistoriaClinica"]["edad"]) ? self::$consulta["HistoriaClinica"]["edad"] : 'No especificado';
                $textoAntecedentesGineco = "Menarquia Presente: " . $presenteMenarquia . " (Edad: " . $edadMenarquia . ")";
                $pdf->Ln();
                ...
                $pdf->SetX(12);
                $pdf->Cell(46.5, 6, utf8_decode('Clasificación:' . (isset(self::$consulta["HistoriaClinica"]["clasificacion_ciclos"]) ? (self::$consulta["HistoriaClinica"]["clasificacion_ciclos"]) : 'No Reporta')), 1);
                $pdf->Cell(46.5, 6, utf8_decode('Frecuencia:' . (isset(self::$consulta["HistoriaClinica"]["frecuencia_ciclos"]) ? (self::$consulta["HistoriaClinica"]["frecuencia_ciclos"]) : 'No Reporta')), 1);
                $pdf->Cell(38.5, 6, utf8_decode('Duración: ' . (isset(self::$consulta["HistoriaClinica"]["frecuencia_ciclos"]) ? self::$consulta["HistoriaClinica"]["frecuencia_ciclos"] : 'No Reporta')), 1);
                $pdf->Cell(54.5, 6, utf8_decode('Fecha última menstruación:' . utf8_decode(isset(self::$consulta["HistoriaClinica"]["fecha_ultima_menstruacion"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["fecha_ultima_menstruacion"]) : 'No Reporta')), 1);
                $pdf->Ln();
                $pdf->SetX(12);
                $pdf->Cell(60.5, 6, utf8_decode('Infecciones de transmisión sexual:' . (isset(self::$consulta["HistoriaClinica"]["presente_transmisionsexual"]) ? (self::$consulta["HistoriaClinica"]["presente_transmisionsexual"]) : 'No Reporta')), 1);
                $pdf->Cell(46.5, 6, utf8_decode('Edad primera relación sexual:' . (isset(self::$consulta["HistoriaClinica"]["edad_primera"]) ? (self::$consulta["HistoriaClinica"]["edad_primera"]) : 'No Reporta')), 1);
                $pdf->Ln();
                $pdf->SetX(12);
                $pdf->MultiCell(186, 6, utf8_decode('Descripción ITS:' . (isset(self::$consulta["HistoriaClinica"]["descripcion_transmision_sexual"]) ? (self::$consulta["HistoriaClinica"]["descripcion_transmision_sexual"]) : 'No Reporta')), 1);
                ...
                $pdf->SetX(12);
                $pdf->Cell(46.5, 6, utf8_decode('Presente:' . (isset(self::$consulta["HistoriaClinica"]["presente_metodo_anticonceptivo"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["presente_metodo_anticonceptivo"]) : 'No Reporta')), 1);
                $pdf->Cell(46.5, 6, utf8_decode('Descripción:' . (isset(self::$consulta["HistoriaClinica"]["descripcion_metodo_anticonceptivo"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["descripcion_metodo_anticonceptivo"]) : 'No Reporta')), 1);
                $pdf->Cell(46.5, 6, utf8_decode('Tipo:' . (isset(self::$consulta["HistoriaClinica"]["tipo_metodo_anticonceptivo"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["tipo_metodo_anticonceptivo"]) : 'No Reporta')), 1);
                $pdf->Cell(46.5, 6, utf8_decode('Tratamiento:' . (isset(self::$consulta["HistoriaClinica"]["tratamiento_metodo_anticonceptivo"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["tratamiento_metodo_anticonceptivo"]) : 'No Reporta')), 1);
                $pdf->Ln();
                $pdf->SetX(12);
                $pdf->Cell(46.5, 6, utf8_decode('Fecha de diagnóstico:' . (isset(self::$consulta["HistoriaClinica"]["fecha_metodo_anticonceptivo"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["fecha_metodo_anticonceptivo"]) : 'No Reporta')), 1);
                $pdf->Ln();
                ...
                $pdf->SetFont('Arial', '', 8);
                $pdf->SetX(12);
                $pdf->Cell(93, 6, utf8_decode('¿Planea embarazo antes de 1 año?:' . (isset(self::$consulta["HistoriaClinica"]["planea_embarazo"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["planea_embarazo"]) : 'No Reporta')), 1);
                if (isset(self::$consulta["HistoriaClinica"]["fecha_ultimo_parto"]) && self::$consulta["HistoriaClinica"]["fecha_ultimo_parto"] !== null) {
                    $pdf->Cell(46.5, 6, utf8_decode('Fecha de último parto: ' . utf8_decode(self::$consulta["HistoriaClinica"]["fecha_ultimo_parto"])), 1);
                    $pdf->Cell(46.5, 6, utf8_decode('Gestas:' . (isset(self::$consulta["HistoriaClinica"]["gesta"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["gesta"]) : 'No Reporta')), 1);
                    $pdf->Ln();
                    $pdf->SetX(12);
                    $pdf->Cell(46.5, 6, utf8_decode('Partos:' . (isset(self::$consulta["HistoriaClinica"]["parto"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["parto"]) : 'No Reporta')), 1);
                    $pdf->Cell(46.5, 6, utf8_decode('Aborto:' . (isset(self::$consulta["HistoriaClinica"]["aborto"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["aborto"]) : 'No Reporta')), 1);
                    $pdf->Cell(46.5, 6, utf8_decode('Vivos:' . (isset(self::$consulta["HistoriaClinica"]["vivos"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["vivos"]) : 'No Reporta')), 1);
                    $pdf->Cell(46.5, 6, utf8_decode('Cesárea:' . (isset(self::$consulta["HistoriaClinica"]["cesarea"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["cesarea"]) : 'No Reporta')), 1);
                    $pdf->Ln();
                    $pdf->SetX(12);
                    $pdf->Cell(46.5, 6, utf8_decode('Mortinato:' . (isset(self::$consulta["HistoriaClinica"]["mortinato"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["mortinato"]) : 'No Reporta')), 1);
                    $pdf->Cell(46.5, 6, utf8_decode('Ectópicos:' . (isset(self::$consulta["HistoriaClinica"]["ectopicos"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["ectopicos"]) : 'No Reporta')), 1);
                    $pdf->Cell(46.5, 6, utf8_decode('Molas:' . (isset(self::$consulta["HistoriaClinica"]["molas"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["molas"]) : 'No Reporta')), 1);
                    $pdf->Cell(46.5, 6, utf8_decode('Gemelos:' . (isset(self::$consulta["HistoriaClinica"]["gemelos"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["gemelos"]) : 'No Reporta')), 1);
                }
                $pdf->Ln();
                ...
                if (isset(self::$consulta["HistoriaClinica"]["fecha_ultima_menstruacion_gestante"]) && self::$consulta["HistoriaClinica"]["fecha_ultima_menstruacion_gestante"] !== null) {
                    ...
                    $pdf->SetX(12);
                    $pdf->Cell(62, 6, utf8_decode('Fecla última mentruación:' . (isset(self::$consulta["HistoriaClinica"]["fecha_ultima_menstruacion_gestante"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["fecha_ultima_menstruacion_gestante"]) : 'No Reporta')), 1);
                    $pdf->Cell(62, 6, utf8_decode('Edad gestacional por FUM:' . (isset(self::$consulta["HistoriaClinica"]["gestacional_fum"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["gestacional_fum"]) : 'No Reporta')), 1);
                    $pdf->Cell(62, 6, utf8_decode('Fecha probable de parto:' . (isset(self::$consulta["HistoriaClinica"]["fecha_probable"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["fecha_probable"]) : 'No Reporta')), 1);
                    $pdf->Ln();
                    $pdf->SetX(12);
                    $pdf->Cell(42.5, 6, utf8_decode('Embarazo deseado:' . (isset(self::$consulta["HistoriaClinica"]["embarazo_deseado"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["embarazo_deseado"]) : 'No Reporta')), 1);
                    $pdf->Cell(43.5, 6, utf8_decode('Embarazo planeado:' . (isset(self::$consulta["HistoriaClinica"]["embarazo_planeado"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["embarazo_planeado"]) : 'No Reporta')), 1);
                    $pdf->Cell(44.5, 6, utf8_decode('Embarazo aceptado:' . (isset(self::$consulta["HistoriaClinica"]["embarazo_aceptado"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["embarazo_aceptado"]) : 'No Reporta')), 1);
                    $pdf->Cell(55.5, 6, utf8_decode('Embarazo Fecha ecografia:' . (isset(self::$consulta["HistoriaClinica"]["fecha_primera_eco"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["fecha_primera_eco"]) : 'No Reporta')), 1);
                    $pdf->Ln();
                    $pdf->SetX(12);
                    $pdf->Cell(62, 6, utf8_decode('Edad gestacional en la ecografia:' . (isset(self::$consulta["HistoriaClinica"]["gestacional_eco_1"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["gestacional_eco_1"]) : 'No Reporta')), 1);
                    $pdf->Cell(62, 6, utf8_decode('Edad gestacional por ecografia:' . (isset(self::$consulta["HistoriaClinica"]["edad_gestacional_ecografia1"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["edad_gestacional_ecografia1"]) : 'No Reporta')), 1);
                    $pdf->Cell(62, 6, utf8_decode('Descripción:' . (isset(self::$consulta["HistoriaClinica"]["descripcion_eco_1"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["descripcion_eco_1"]) : 'No Reporta')), 1);
                    $pdf->Ln();

                    $pdf->SetX(12);
                    $pdf->Cell(62, 6, utf8_decode('Edad gestacional en la ecografia 2:' . (isset(self::$consulta["HistoriaClinica"]["gestacional_eco_2"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["gestacional_eco_2"]) : 'No Reporta')), 1);
                    $pdf->Cell(62, 6, utf8_decode('Edad gestacional por ecografia 2:' . (isset(self::$consulta["HistoriaClinica"]["edad_gestacional_ecografia2"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["edad_gestacional_ecografia2"]) : 'No Reporta')), 1);
                    $pdf->Cell(62, 6, utf8_decode('Descripción:' . (isset(self::$consulta["HistoriaClinica"]["descripcion_eco_2"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["descripcion_eco_2"]) : 'No Reporta')), 1);
                    $pdf->Ln();


                    $pdf->SetX(12);
                    $pdf->Cell(62, 6, utf8_decode('Edad gestacional en la ecografia 3:' . (isset(self::$consulta["HistoriaClinica"]["gestacional_eco_3"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["gestacional_eco_3"]) : 'No Reporta')), 1);
                    $pdf->Cell(62, 6, utf8_decode('Edad gestacional por ecografia 3:' . (isset(self::$consulta["HistoriaClinica"]["edad_gestacional_ecografia3"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["edad_gestacional_ecografia3"]) : 'No Reporta')), 1);
                    $pdf->Cell(62, 6, utf8_decode('Descripción:' . (isset(self::$consulta["HistoriaClinica"]["descripcion_eco_3"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["descripcion_eco_3"]) : 'No Reporta')), 1);

                    $pdf->Ln();
                }
            } else {
                $textoAntecedentesGineco = "Menarquia Presente: " . $presenteMenarquia;
            }
        ...
        // $pdf->SetX(12);
        // $pdf->Cell(46.5, 6, utf8_decode('Orientación Sexual: ' . (self::$consulta["antecedenteEcomapa"]["orientacion_sex"] ?? 'No Evaluado')), 1);
        // $pdf->Cell(46.5, 6, utf8_decode('Identidad género: ' . (self::$consulta["antecedenteEcomapa"]["identidad_genero"] ?? 'No Evaluado')), 1);
        // if (isset(self::$consulta["antecedenteEcomapa"]["identidad_genero"]) == 'Transgenero') {
        //     $pdf->Cell(46.5, 6, utf8_decode('Tipo: ' . (self::$consulta["antecedenteEcomapa"]["identidad_generotransgenero"] ?? 'No Evaluado')), 1);
        // }
        // $pdf->Cell(46.5, 6, utf8_decode('Número de compañeros sexuales: ' . (self::$consulta["antecedenteEcomapa"]["numero_relaciones"] ?? 'No Evaluado')), 1);

        // $pdf->Ln();
        // $pdf->SetX(12);
        // $pdf->Cell(62, 6, utf8_decode('Activo sexualmente: ' . (self::$consulta["antecedenteEcomapa"]["activo_sexual"] ?? 'No Evaluado')), 1);
        // $pdf->Cell(62, 6, utf8_decode('Dificultades durante las relaciones: ' . (self::$consulta["antecedenteEcomapa"]["dificultades_relaciones"] ?? 'No Evaluado')), 1);
        // if (isset(self::$consulta["antecedenteEcomapa"]["dificultades_relaciones"]) == 'Si') {
        //     $pdf->Cell(62, 6, utf8_decode('Descripción dificultad: ' . (self::$consulta["antecedenteEcomapa"]["descripciondificultad"] ?? 'No Evaluado')), 1);
        // }
        // $pdf->Ln();
        // $pdf->SetX(12);
        // $pdf->Cell(62, 6, utf8_decode('Método anticonceptivo: ' . (self::$consulta["antecedenteEcomapa"]["uso_anticonceptivos"] ?? 'No Evaluado')), 1);
        // if (isset(self::$consulta["antecedenteEcomapa"]["uso_anticonceptivos"]) == 'Si') {
        //     $pdf->Cell(62, 6, utf8_decode('Tipo: ' . (self::$consulta["antecedenteEcomapa"]["tipo_anticonceptivos"] ?? 'No Evaluado')), 1);
        // }
        // $pdf->Cell(62, 6, utf8_decode('Conocimiento en enfermedades ITS: ' . (self::$consulta["antecedenteEcomapa"]["conocimiento_its"] ?? 'No Evaluado')), 1);
        // $pdf->Ln();
        // $pdf->SetX(12);
        // $pdf->Cell(93, 6, utf8_decode('¿Ha sufrido alguna enfermedad de transmisión sexual?: ' . (self::$consulta["antecedenteEcomapa"]["sufrido_its"] ?? 'No Evaluado')), 1);
        // if (isset(self::$consulta["antecedenteEcomapa"]["sufrido_its"]) == 'Si') {
        //     $pdf->Cell(46.5, 6, utf8_decode('¿Cuál?: ' . (self::$consulta["antecedenteEcomapa"]["cualits"] ?? 'No Evaluado')), 1);
        //     $pdf->Cell(46.5, 6, utf8_decode('Fecha enfermedad: ' . (self::$consulta["antecedenteEcomapa"]["fecha_enfermedadits"] ?? 'No Evaluado')), 1);
        //     $pdf->Ln();
        //     $pdf->SetX(12);
        //     $pdf->Cell(93, 6, utf8_decode('Tratamiento: ' . (self::$consulta["antecedenteEcomapa"]["tratamientoits"] ?? 'No Evaluado')), 1);
        // }
        // if (isset(self::$consulta["afiliado"]["edad_cumplida"]) > 11) {
        //     $pdf->Cell(93, 6, utf8_decode('¿Utiliza protección para prevenir enfermedades: ' . (self::$consulta["antecedenteEcomapa"]["trasnmision_sexual"] ?? 'No Evaluado')), 1);
        //     $pdf->Ln();
        //     $pdf->SetX(12);
        //     $pdf->Cell(93, 6, utf8_decode('Conocimiento sobre derechos sexuales y reproductivos: ' . (self::$consulta["antecedenteEcomapa"]["derechos_sexuales"] ?? 'No Evaluado')), 1);
        //     $pdf->Cell(93, 6, utf8_decode('¿Ha sido victima de identidad de Genero?: ' . (self::$consulta["antecedenteEcomapa"]["victima_identidadgenero"] ?? 'No Evaluado')), 1);
        //     $pdf->Ln();
        //     $pdf->SetX(12);
        //     $pdf->Cell(62, 6, utf8_decode('Tipo violencia: ' . (self::$consulta["antecedenteEcomapa"]["tipo_victimagenero"] ?? 'No Evaluado')), 1);
        //     $pdf->Cell(62, 6, utf8_decode('¿Ha sido victima de violencia?: ' . (self::$consulta["antecedenteEcomapa"]["victima_genero"] ?? 'No Evaluado')), 1);
        //     if (isset(self::$consulta["antecedenteEcomapa"]["victima_genero"]) == 'Si') {
        //         $pdf->Cell(62, 6, utf8_decode('Tipo: ' . (self::$consulta["antecedenteEcomapa"]["tipo_victima_violencia_genero"] ?? 'No Evaluado')), 1);
        //     }
        //     $pdf->Ln();
        //     $pdf->SetX(12);
        //     $pdf->Cell(93, 6, utf8_decode('¿Ha sufrido violencia Fisica o sexual?: ' . (self::$consulta["antecedenteEcomapa"]["violencia"] ?? 'No Evaluado')), 1);
        //     $pdf->Ln();
        //     $pdf->SetX(12);

        //     $pdf->Cell(186, 6, utf8_decode('¿Ha sido víctima de mutilación genital?: ' . (self::$consulta["antecedenteEcomapa"]["presenciamutilacion"] ?? 'No Evaluado')), 1);
        //     $pdf->Ln();
        //     $pdf->SetX(12);
        //     $pdf->Cell(186, 6, utf8_decode('¿Ha sido víctima de matrimonio forzoso o en etapa infantil?: ' . (self::$consulta["antecedenteEcomapa"]["matrimonioinfantil"] ?? 'No Evaluado')), 1);
        //     $pdf->Ln();
        //     $pdf->Ln();
        // }
        // $pdf->Ln();
        ...
        // $pdf->SetX(12);
        // $pdf->SetFont('Arial', '', 8);
        // $trabaja = isset(self::$consultaself::$consulta["antecedenteEcomapa"]["trabaja"]) ? self::$consultaself::$consulta["antecedenteEcomapa"]["trabaja"] : 'No Reporta';
        // $asisteIglesia = isset(self::$consultaself::$consulta["antecedenteEcomapa"]["asiste_iglesia"]) ? self::$consultaself::$consulta["antecedenteEcomapa"]["asiste_iglesia"] : 'No Reporta';
        // $perteneceClubDeportivo = isset(self::$consultaself::$consulta["antecedenteEcomapa"]["pertenece_club_deportivo"]) ? self::$consultaself::$consulta["antecedenteEcomapa"]["pertenece_club_deportivo"] : 'No Reporta';
        ...
        // $comparteAmigos = isset(self::$consultaself::$consulta["antecedenteEcomapa"]["comparte_amigos"]) ? self::$consultaself::$consulta["antecedenteEcomapa"]["comparte_amigos"] : 'No Reporta';
        // $asisteColegio = isset(self::$consultaself::$consulta["antecedenteEcomapa"]["asiste_colegio"]) ? self::$consultaself::$consulta["antecedenteEcomapa"]["asiste_colegio"] : 'No Reporta';
        // $comparteVecinos = isset(self::$consultaself::$consulta["antecedenteEcomapa"]["comparte_vecinos"]) ? self::$consultaself::$consulta["antecedenteEcomapa"]["comparte_vecinos"] : 'No Reporta';
        // $perteneceClub = isset(self::$consultaself::$consulta["antecedenteEcomapa"]["pertenece_club_social_cultural"]) ? self::$consultaself::$consulta["antecedenteEcomapa"]["pertenece_club_social_cultural"] : 'No Reporta';
        ...
        // $ayudaFamiliaTexto = $ayudaFamilia === null ? 'No Reporta' : ($ayudaFamilia == 1 ? 'ALGUNAS VECES' : ($ayudaFamilia == 2 ? 'CASI SIEMPRE' : ($ayudaFamilia == 4 ? 'SIEMPRE' : 'CASI NUNCA')));
        ...
        // $familiaHablaTexto = $familiaHabla === null ? 'No Reporta' : ($familiaHabla == 1 ? 'ALGUNAS VECES' : ($familiaHabla == 2 ? 'CASI SIEMPRE' : ($familiaHabla == 4 ? 'SIEMPRE' : 'CASI NUNCA')));
        ...
        // $cosasNuevasTexto = $cosasNuevas === null ? 'No Reporta' : ($cosasNuevas == 1 ? 'ALGUNAS VECES' : ($cosasNuevas == 2 ? 'CASI SIEMPRE' : ($cosasNuevas == 4 ? 'SIEMPRE' : 'CASI NUNCA')));
        ...
        // $leGustaFamiliaComparteTexto = $leGustaFamiliaComparte === null ? 'No Reporta' : ($leGustaFamiliaComparte == 1 ? 'ALGUNAS VECES' : ($leGustaFamiliaComparte == 2 ? 'CASI SIEMPRE' : ($leGustaFamiliaComparte == 4 ? 'SIEMPRE' : 'CASI NUNCA')));
        ...
        // $resultado = isset(self::$consulta["apgarFamiliar"]["resultado"]) ? self::$consulta["apgarFamiliar"]["resultado"] : 'No Reporta';
        ...
        // $vinculos = isset(self::$consulta["antecedenteFamiliograma"]["vinculos"]) ? utf8_decode(self::$consulta["antecedenteFamiliograma"]["vinculos"]) : 'No Reporta';
        // $tipo_familia = isset(self::$consulta["antecedenteFamiliograma"]["tipo_familia"]) ? self::$consulta["antecedenteFamiliograma"]["tipo_familia"] : 'No Reporta';
        // $relacionAfectiva = isset(self::$consulta["antecedenteFamiliograma"]["relacion"]) ? self::$consulta["antecedenteFamiliograma"]["relacion"] : 'No Reporta';
        // $problemasSalud = isset(self::$consulta["antecedenteFamiliograma"]["problemas_de_salud"]) ? self::$consulta["antecedenteFamiliograma"]["problemas_de_salud"] : 'No Reporta';
        // $cualFamiliograma = isset(self::$consulta["antecedenteFamiliograma"]["cual_salud"]) ? self::$consulta["antecedenteFamiliograma"]["cual_salud"] : 'No Reporta';
        // $responsable_ingreso = isset(self::$consulta["antecedenteFamiliograma"]["responsable_ingreso"]) ? self::$consulta["antecedenteFamiliograma"]["responsable_ingreso"] : 'No Reporta';
        // $observacionesFamiliograma = isset(self::$consulta["antecedenteFamiliograma"]["observacion_salud"]) ? self::$consulta["antecedenteFamiliograma"]["observacion_salud"] : 'No Reporta';
        ...
        if (!in_array(self::$consulta["especialidad_id"], [43, 45])) {
            ...
            $pdf->Cell(27, 4, utf8_decode(isset(self::$consulta["HistoriaClinica"]["imc"]) && self::$consulta["HistoriaClinica"]["imc"] !== null ? "IMC: " . self::$consulta["HistoriaClinica"]["imc"] : "IMC: No Reporta"), 1, 0, 'L', 0);
            $pdf->Cell(69, 4, utf8_decode(isset(self::$consulta["HistoriaClinica"]["isc"]) && self::$consulta["HistoriaClinica"]["isc"] !== null ? "Índice de superficie corporal: " . self::$consulta["HistoriaClinica"]["isc"] : "Índice de superficie corporal: No Reporta"), 1, 0, 'L', 0);
            $pdf->Ln();
            ...
            $pdf->SetDrawColor(0, 0, 0);
            $pdf->SetFont('Arial', '', 8);
            $pdf->Cell(186, 4, utf8_decode(isset(self::$consulta["HistoriaClinica"]["perimetro_abdominal"]) && self::$consulta["HistoriaClinica"]["perimetro_abdominal"] !== null ? "Perímetro abdominal: " . self::$consulta["HistoriaClinica"]["perimetro_abdominal"] : "Perímetro abdominal: No Reporta"), 1, 0, 'L', 0);
            $pdf->Ln();
            $pdf->SetX(12);
            $pdf->Cell(186, 4, utf8_decode(isset(self::$consulta["HistoriaClinica"]["clasificacion"]) && self::$consulta["HistoriaClinica"]["clasificacion"] !== null ? "Clasificación: " . self::$consulta["HistoriaClinica"]["clasificacion"] : "Clasificación: No Reporta"), 1, 0, 'L', 0);
            $pdf->Ln();
            if (self::$consulta["afiliado"]["ciclo_vida_atencion"] === "Primera Infancia (0-5 Años)") {
                $pdf->Cell(62, 4, utf8_decode('Perimetro Cefálico:' . (isset(self::$consulta["HistoriaClinica"]["perimetro_cefalico"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["perimetro_cefalico"]) : 'No Reporta')), 1);
            ...
            if (
                ...
                $pdf->Cell(186, 4, utf8_decode("Circunferencia brazo: " .
                    (isset(self::$consulta["HistoriaClinica"]["circunferencia_brazo"]) && self::$consulta["HistoriaClinica"]["circunferencia_brazo"] !== null
                        ? self::$consulta["HistoriaClinica"]["circunferencia_brazo"]
                        : "No refiere")), 1, 0, 'L', 0);
                $pdf->Ln();
            }
        }
        ...
        if (!in_array(self::$consulta["especialidad_id"], [42, 43, 44, 45])) {
            ...
            $pdf->Cell(62, 4, utf8_decode(isset(self::$consulta["HistoriaClinica"]["fio"]) && self::$consulta["HistoriaClinica"]["fio"] !== null ? "Fracción inspiratoria de oxígeno: " . self::$consulta["HistoriaClinica"]["fio"] : "Fracción inspiratoria de oxígeno: No Reporta"), 1, 0, 'L', 0);
            $pdf->Ln();
            $pdf->Ln();
        }
        ...
        if (self::$consulta["especialidad_id"] !== 43) {
            ...
            $pdf->SetX(12);
            $pdf->SetFont('Arial', '', 9);
            $pdf->MultiCell(186, 4, "Examen Cardiorespiratorio: " . utf8_decode(isset(self::$consulta["HistoriaClinica"]["examen_cardiorespiratorio"]) && self::$consulta["HistoriaClinica"]["examen_cardiorespiratorio"] !== null ? self::$consulta["HistoriaClinica"]["examen_cardiorespiratorio"] : 'sin hallazgos'), 1, 'L', 0);
        ...
        $pdf->SetX(12);
        $pdf->SetFont('Arial', '', 8);
        $pdf->MultiCell(186, 4, utf8_decode("Funciones de la articulación, voz y habla: ") . utf8_decode(self::$consulta["HistoriaClinica"]["funciones"] ?? 'No Reporta'), 1, 'L', 0);

        $pdf->SetX(12);
        $pdf->SetFont('Arial', '', 8);
        $pdf->MultiCell(186, 4, utf8_decode("Desempeño comunicativo: ") . utf8_decode(self::$consulta["HistoriaClinica"]["desempenio_comunicativo"] ?? 'No Reporta'), 1, 'L', 0);

        $pdf->SetX(12);
        $pdf->SetFont('Arial', '', 8);
        $pdf->MultiCell(186, 4, "Resultado cuestionario: " . utf8_decode(self::$consulta["HistoriaClinica"]["resultado_vale"] ?? 'No Reporta'), 1, 'L', 0);

        $pdf->SetX(12);
        $pdf->SetFont('Arial', '', 8);
        $pdf->MultiCell(186, 4, utf8_decode("Lista de chequeo de factores de riesgo de las enfermedades del oído: ") . utf8_decode(self::$consulta["HistoriaClinica"]["factores_oido"] ?? 'No Reporta'), 1, 'L', 0);
        $pdf->Ln();
        ...
        $pdf->SetX(12);
        $pdf->SetFont('Arial', '', 8);
        $pdf->MultiCell(186, 4, "Violencia: " . utf8_decode(self::$consulta["HistoriaClinica"]["violencia_mental"] ?? 'No Reporta'), 1, 'L', 0);

        $pdf->SetX(12);
        $pdf->SetFont('Arial', '', 8);
        $pdf->MultiCell(186, 4, "Violencia conflicto armado: " . utf8_decode(self::$consulta["HistoriaClinica"]["violencia_conflicto"] ?? 'No Reporta'), 1, 'L', 0);

        if (self::$consulta["afiliado"]["edad_cumplida"] >= 12 && self::$consulta["afiliado"]["edad_cumplida"] <= 50) {
            $pdf->SetX(12);
            $pdf->SetFont('Arial', '', 8);
            $pdf->MultiCell(186, 4, "Violencia sexual: " . utf8_decode(self::$consulta["HistoriaClinica"]["violencia_sexual"] ?? 'No Reporta'), 1, 'L', 0);
        }

        if (self::$consulta["afiliado"]["edad_cumplida"] >= 12 && self::$consulta["afiliado"]["edad_cumplida"] <= 50) {
            $pdf->SetX(12);
            $pdf->SetFont('Arial', '', 8);
            $pdf->MultiCell(186, 4, "Lesiones autoinflingidas: " . utf8_decode(self::$consulta["HistoriaClinica"]["lesiones_auto_inflingidas"] ?? 'No Reporta'), 1, 'L', 0);
            $pdf->Ln();
        }
        ...
        $pdf->SetFont('arial', 'B', '9');
        $pdf->SetFillColor(214, 214, 214);
        $pdf->Cell(186, 4, utf8_decode('TEST RQC'), 1, 0, 'C', 1);
        $pdf->SetTextColor(0, 0, 0);
        $pdf->SetDrawColor(0, 0, 0);
        $pdf->Ln();
        $pdf->SetX(12);
        $pdf->SetFont('arial', '', '9');
        $pdf->Cell(186, 4, utf8_decode("Resultado del test: ") . utf8_decode(isset(self::$consulta["TestRqc"]["interpretacion_resultado"]) && self::$consulta["TestRqc"]["interpretacion_resultado"] !== null ? self::$consulta["TestRqc"]["interpretacion_resultado"] : 'No refiere'), 1, 0, 'L');
        $pdf->Ln();
        ...
        $pdf->SetFont('arial', 'B', '9');
        $pdf->SetFillColor(214, 214, 214);
        $pdf->Cell(186, 4, utf8_decode('TEST SRQC'), 1, 0, 'C', 1);
        $pdf->SetTextColor(0, 0, 0);
        $pdf->SetDrawColor(0, 0, 0);
        $pdf->Ln();
        $pdf->SetX(12);
        $pdf->SetFont('arial', '', '9');
        $pdf->SetFillColor(255, 255, 255);
        $pdf->MultiCell(186, 4, utf8_decode("Resultado del test: ") . utf8_decode(isset(self::$consulta["testSrq"]["interpretacion_resultado"]) && self::$consulta["testSrq"]["interpretacion_resultado"] !== null ? self::$consulta["testSrq"]["interpretacion_resultado"] : 'No refiere'), 1, 0, 'L');
        $pdf->Ln();
        ...
        $pdf->SetFont('arial', 'B', '9');
        $pdf->SetFillColor(214, 214, 214);
        $pdf->Cell(186, 4, utf8_decode('TEST AUDIT'), 1, 0, 'C', 1);
        $pdf->SetTextColor(0, 0, 0);
        $pdf->SetDrawColor(0, 0, 0);
        $pdf->Ln();
        $pdf->SetX(12);
        $pdf->SetFont('arial', '', '9');
        $pdf->Cell(186, 4, utf8_decode("Resultado del test: ") . utf8_decode(isset(self::$consulta["audit"]["interpretacion_resultados"]) && self::$consulta["audit"]["interpretacion_resultados"] !== null ? self::$consulta["audit"]["interpretacion_resultados"] : 'No refiere'), 1, 0, 'L');
        $pdf->Ln();
        ...
        $firstRemision = self::$consulta->remision->first();
        $remisionPrograma = $firstRemision->remision_programa ?? 'No Reporta';
        $observacion = $firstRemision->observacion ?? 'No Reporta';
        $pdf->SetX(12);
        $pdf->SetFont('Arial', '', 8);
        $pdf->MultiCell(186, 4, "Programa remitido: " . utf8_decode($remisionPrograma), 1, 'L', 0);

        $pdf->SetX(12);
        $pdf->SetFont('Arial', '', 8);
        $pdf->MultiCell(186, 4, "Observacion: " . utf8_decode($observacion), 1, 'L', 0);
