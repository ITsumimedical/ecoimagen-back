...
class HistoriaClinicaRiesgoCardioVascular extends Fpdf
{
    protected static $consulta;

    public function bodyRiesgoCardioVascular($pdf, $consulta)
    {
        ...
        if ($noTieneAntecedentes) {
            ...
            foreach ($antecedentesFamiliares as $familiares) {
                ...
                $pdf->SetX(12);
                $pdf->MultiCell(186, 4, utf8_decode('PARENTESCO: ' . utf8_decode($parentesco)), 1, 'L');
        ...
        if ($noTieneAntecedentesVacunales) {
            ...
            foreach ($antecedentesVacunales as $vacuna) {
                ...
                // Concatenar los tres campos
                $detalleVacuna = utf8_decode('VACUNA: ' . utf8_decode($vacunaNombre) . ' | DOSIS: ' . utf8_decode($dosis) . ' | FECHA DE DOSIS: ' . $fechaDosis . ' | REGISTRADO POR: ' . utf8_decode($nombreCompletoMedico));
        ...
        if ($noTieneAntecedentesQuirurgicos) {
            ...
            foreach ($antecedentesQuirurgicos as $quirurgico) {
                ...
                $pdf->MultiCell(186, 4, utf8_decode('CIRUGÍA: ' . utf8_decode($cirugia)), 1, 'L');

                // Observaciones
                $observaciones = utf8_decode($quirurgico->observaciones ?? 'Sin observaciones');
                $pdf->SetX(12);
                $pdf->MultiCell(186, 4, utf8_decode('OBSERVACIONES: ' . utf8_decode($observaciones)), 1, 'L');
                ...
                $detalleQuirurgico = utf8_decode('EDAD: ' . utf8_decode($edad) . ' | REGISTRADO POR: ' . utf8_decode($nombreCompletoMedico));
        ...
        if (self::$consulta["afiliado"]["sexo"] == 'F' && self::$consulta["afiliado"]["edad_cumplida"] >= 13 && self::$consulta["afiliado"]["edad_cumplida"] <= 59) {
            $pdf->SetX(12);
            $pdf->SetFont('Arial', 'B', 9);
            $pdf->SetDrawColor(0, 0, 0);
            $pdf->SetFillColor(214, 214, 214);
            ...
            $pdf->SetX(12);
            $pdf->Cell(62, 6, utf8_decode('¿Presente tratamiento de infertilidad?:' . (isset(self::$consulta["HistoriaClinica"]["presente_tratamiento_infertilidad"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["presente_tratamiento_infertilidad"]) : 'No Reporta')), 1);
            if (self::$consulta["HistoriaClinica"]["presente_tratamiento_infertilidad"] == 'Sí') {
                $pdf->Cell(62, 6, utf8_decode('Descripción tratamiento: ' . (isset(self::$consulta["HistoriaClinica"]["tratamiento_tratamiento_infertilidad"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["tratamiento_tratamiento_infertilidad"]) : 'No Reporta')), 1);
                $pdf->Cell(62, 6, utf8_decode('Fecha del tratamiento: ' . (isset(self::$consulta["HistoriaClinica"]["fecha_tratamiento_infertilidad"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["fecha_tratamiento_infertilidad"]) : 'No Reporta')), 1);
            }
            $pdf->Ln();
            ...
            $pdf->SetX(12);
            $pdf->Cell(93, 6, utf8_decode('¿Practica autoexamen de senos?:' . (isset(self::$consulta["HistoriaClinica"]["presente_auto_examen_senos"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["presente_auto_examen_senos"]) : 'No Reporta')), 1);
            if (self::$consulta["HistoriaClinica"]["presente_auto_examen_senos"] == 'Si') {
                $pdf->Cell(93, 6, utf8_decode('Frecuencia en que lo realiza:' . (isset(self::$consulta["HistoriaClinica"]["frecuencia_auto_examen_senos"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["frecuencia_auto_examen_senos"]) : 'No Reporta')), 1);
            }
            $pdf->Ln();

            // Autocuidado de senos
            if (self::$consulta["afiliado"]["sexo"] == 'F' && self::$consulta["afiliado"]["edad_cumplida"] >= 60) {
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetDrawColor(0, 0, 0);
                $pdf->SetX(12);
                $pdf->SetFont('Arial', 'B', 9);
                $pdf->Cell(186, 4, utf8_decode('MENOPAUSIA'), 1, 0, 'C', 1);
                $pdf->Ln();
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetDrawColor(0, 0, 0);
                $pdf->SetFont('Arial', '', 8);
                $pdf->SetX(12);
                $pdf->Cell(93, 6, utf8_decode('¿Menopausia presente?:' . (isset(self::$consulta["HistoriaClinica"]["menopausia_presente"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["menopausia_presente"]) : 'No Reporta')), 1);
                if (self::$consulta["HistoriaClinica"]["menopausia_presente"] == 'Si') {
                    $pdf->Cell(93, 6, utf8_decode('Edad de inicio:' . (isset(self::$consulta["HistoriaClinica"]["fecha_inicio_menopausia"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["fecha_inicio_menopausia"]) : ' No Reporta')), 1);
                }
                $pdf->Ln();
            }
            ...
            $pdf->SetX(12);
            $pdf->Cell(93, 6, utf8_decode('Procedimientos en el cuello uterino:' . (isset(self::$consulta["HistoriaClinica"]["presente_procedimiento_cuello_uterino"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["presente_procedimiento_cuello_uterino"]) : 'No Reporta')), 1);
            if (self::$consulta["HistoriaClinica"]["presente_procedimiento_cuello_uterino"] == 'Si') {
                $pdf->Cell(93, 6, utf8_decode('Tratamiento en el cuello uterino:' . (isset(self::$consulta["HistoriaClinica"]["tratamiento_procedimiento_cuello_uterino"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["tratamiento_procedimiento_cuello_uterino"]) : 'No Reporta')), 1);
                $pdf->Ln();
                $pdf->SetX(12);
                $pdf->Cell(93, 6, utf8_decode('Fecha del procedimiento:' . (isset(self::$consulta["HistoriaClinica"]["fecha_procedimiento_cuello_uterino"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["fecha_procedimiento_cuello_uterino"]) : 'No Reporta')), 1);
            }
            $pdf->Ln();
            ...
            $textoAntecedentesOtrosTratamientos = "OTRO: " . (isset(self::$consulta["HistoriaClinica"]["tratamiento_otro_tipo_tratamiento"]) ? utf8_decode(self::$consulta["HistoriaClinica"]["tratamiento_otro_tipo_tratamiento"]) : 'No');
            $pdf->SetX(12);
        ...
        $pdf->SetFillColor(214, 214, 214);
        $pdf->SetTextColor(0, 0, 0);
        $pdf->Cell(186, 4, utf8_decode('RESULTADO TEST DE FRAMINGHAM'), 1, 0, 'C', 1);
        $pdf->Ln();
        $pdf->SetX(12);
        $pdf->SetFont('Arial', '', 9);
        $pdf->MultiCell(186, 4, utf8_decode(isset(self::$consulta["framingham"]["resultado"]) && self::$consulta["framingham"]["resultado"] !== null ? self::$consulta["framingham"]["resultado"] : 'No reporta'), 1, 'L', 0);
        $pdf->Ln();
        ...
        $pdf->SetX(12);
        $pdf->SetFont('Arial', '', 9);
        $pdf->MultiCell(186, 4, utf8_decode(isset(self::$consulta["findrisc"]["resultado"]) && self::$consulta["findrisc"]["resultado"] !== null ? self::$consulta["findrisc"]["resultado"] : 'No reporta'), 1, 'L', 0);
        $pdf->Ln();
