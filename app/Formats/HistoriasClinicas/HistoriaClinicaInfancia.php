...
class HistoriaClinicaInfancia extends Fpdf
{
    protected static $consulta;

    public function bodyHcInfancia($pdf, $consulta)
    {
        ...
        $consultarFarmacologicos = AntecedentesFarmacologico::where('consulta_id', self::$consulta->id)->with('principioActivo')->get();
        ...
        if (isset(self::$consulta->antecedentesFarmacologicos)) {
            ...
            foreach ($consultarFarmacologicos as $farmacologico) {
                ...
                $medico = utf8_decode($farmacologico->operador ?? 'No refiere');
        ...
        $pdf->SetX(12);
        $pdf->SetFont('arial', '', '9');
        $pdf->Cell(186, 4, utf8_decode("Edad mental del niño: ") . utf8_decode(isset(self::$consulta["FiguraHumana"]["interpretacion_resultados"]) && self::$consulta["FiguraHumana"]["interpretacion_resultados"] !== null ? self::$consulta["FiguraHumana"]["interpretacion_resultados"] : 'No refiere'), 1, 0, 'L');
        $pdf->Ln();
