...
class HistoriaClinicaPsicologiaAdulto extends Fpdf
{
    protected static $consulta;

    public function bodyPsicologiaAdulto($pdf, $consulta)
    {
        ...
        $pdf->SetFillColor(214, 214, 214);
        $pdf->SetTextColor(0, 0, 0);
        $pdf->Cell(186, 6, utf8_decode('VALORACIÓN PSICOLÓGICA'), 1, 0, 'C', 1);
        $pdf->Ln();
        $pdf->SetX(12);
        $pdf->SetFillColor(255, 255, 255);
        $pdf->SetFont('Arial', '', 9);
        $pdf->MultiCell(186, 4, utf8_decode("Estado de ánimo: ") . utf8_decode(isset(self::$consulta["estadoComportamiento"]["estado_animo"]) && self::$consulta["estadoComportamiento"]["estado_animo"] !== null ? self::$consulta["estadoComportamiento"]["estado_animo"] : 'No refiere'), 1, 0, 'L');
        $pdf->SetX(12);
        $pdf->SetFillColor(255, 255, 255);
        $pdf->MultiCell(186, 4, utf8_decode("Comportamiento: ") . utf8_decode(isset(self::$consulta["estadoComportamiento"]["comportamiento"]) && self::$consulta["estadoComportamiento"]["comportamiento"] !== null ? self::$consulta["estadoComportamiento"]["comportamiento"] : 'No refiere'), 1, 0, 'L');
        $pdf->SetX(12);
        $pdf->SetFillColor(255, 255, 255);
        $pdf->MultiCell(186, 4, utf8_decode("Activdidades básicas: ") . utf8_decode(isset(self::$consulta["estadoComportamiento"]["actividades_basicas"]) && self::$consulta["estadoComportamiento"]["actividades_basicas"] !== null ? self::$consulta["estadoComportamiento"]["actividades_basicas"] : 'No refiere'), 1, 0, 'L');
        $pdf->Ln();
        ...
        $pdf->SetX(12);
        $pdf->SetFont('Arial', '', 9);
        $pdf->Cell(186, 4, "Resultado: " . utf8_decode(isset(self::$consulta["apgarFamiliar"]["interpretacion_resultado"]) && self::$consulta["apgarFamiliar"]["interpretacion_resultado"] !== null ? self::$consulta["apgarFamiliar"]["interpretacion_resultado"] : 'No refiere'), 1, 1, 'L');
        $pdf->SetX(12);
        $pdf->Ln();
