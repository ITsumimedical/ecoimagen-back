...
class HistoriaClinicaJoven extends Fpdf
{
    protected static $consulta;

    public function bodyHcJoven($pdf, $consulta)
    {
        ...
        $pdf->SetFont('Arial', 'B', 9);
        $pdf->SetFillColor(214, 214, 214);
        $pdf->Cell(186, 4, utf8_decode('APGAR FAMILIAR'), 1, 1, 'C', 1);
        $pdf->SetX(12);
        $pdf->SetFont('Arial', '', 9);
        $pdf->Cell(186, 4, utf8_decode("Resultado: ") . utf8_decode(isset(self::$consulta["apgarFamiliar"]["interpretacion_resultado"]) && self::$consulta["apgarFamiliar"]["interpretacion_resultado"] !== null ? self::$consulta["apgarFamiliar"]["interpretacion_resultado"] : 'No Refiere'), 1, 0, 'L');
        $pdf->Ln();
        $pdf->Ln();
        ...
        if (!in_array(self::$consulta["especialidad_id"], [42, 43, 44, 45])) {
            ...
            $pdf->Cell(62, 4, utf8_decode(isset(self::$consulta["HistoriaClinica"]["fio"]) && self::$consulta["HistoriaClinica"]["fio"] !== null ? "Fracción inspiratoria de oxígeno: " . self::$consulta["HistoriaClinica"]["fio"] : "Fracción inspiratoria de oxígeno: "), 1, 0, 'L', 0);
            $pdf->Ln();
            $pdf->Ln();
        }
