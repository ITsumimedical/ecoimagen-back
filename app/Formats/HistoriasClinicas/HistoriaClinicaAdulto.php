...
class HistoriaClinicaAdulto extends Fpdf
{
    protected static $consulta;

    public function bodyHcAdulto($pdf, $consulta)
    {
        ...
        $pdf->SetTextColor(0, 0, 0);
        $pdf->SetX(12);
        $pdf->Cell(186, 4, utf8_decode(isset(self::$consulta["apgarFamiliar"]["interpretacion_resultado"])), 1, 1, 'L');
        ...
        $pdf->SetFillColor(214, 214, 214);
        $pdf->SetTextColor(0, 0, 0);
        $pdf->Cell(186, 4, utf8_decode('RESULTADO TEST FRAMINGHAM'), 1, 0, 'C', 1);
        $pdf->Ln();

        $pdf->SetX(12);
        $pdf->SetFont('Arial', '', 8);
        $pdf->MultiCell(186, 4, utf8_decode(self::$consulta["framingham"]["resultado"] ?? 'No refiere'), 1, 'L', 0);
        $pdf->Ln();
        ...
        if (isset($consulta['familiograma'])) {
            ...
            $pdf->Ln();
            $pdf->SetX(12);
            $pdf->Cell(186, 4, utf8_decode('No se ha cargado un familiograma para esta consulta o la imagen no esta disponible.'), 1, 0, 'C', 0);
        }
        $pdf->Ln();
        $pdf->Ln();
