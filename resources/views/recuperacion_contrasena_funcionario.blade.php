                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600"
                    ...
                    <tr>
                        <td align="center" bgcolor="#fff"
                            ...
                            <img src="{{ url('/images/logoFomag.png') }}" alt="Logo" width="300" height="230"
                                style="display: block;" />
                        </td>
                    </tr>
                    <tr>
                                            ...
                                            <tr>
                                                <td width="260" valign="top">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td>
                                                                <p> <a href="https://horus2.horus-health.com/"
                                                                        style="color: #ffffff;">horus2.horus-health<font
                                                                            color="#ffffff"></font></a>
                                                                </p>
                                                            </td>
                                                        </tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="color: #ffffff; font-family: Arial, sans-serif; font-size: 14px;"
                                        width="75%">
                                        &reg; FOMAG 2025<br />
                                        <a href="https://horus2.horus-health.com/" style="color: #ffffff;">Fomag
