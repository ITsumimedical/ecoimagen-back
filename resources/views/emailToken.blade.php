                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td
                                        ...
                                        <p>Estimado(a):</p>
                                        <p>A continuación le brindamos el token de acceso para restablecer su contraseña
                                            o iniciar sesion. Recuerde no compartir o reenviar este mensaje debido que
                                            este ha sido generado automáticamente.</p>
                                            <p><b>"client_id": </b>"{{ $id }}"</p>
                                            <p><b>"client_secret": </b>"{{ $detalle }}"</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                            ...
                                            <tr>
                                                <td width="260" valign="top">
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <p> <a href="https://horus-health.com/"
                                                                        style="color: #ffffff;">Token de acceso<font
                                                                            color="#ffffff"></font></a>
                                                                </p>
                                                            </td>
                                                        </tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="color: #ffffff; font-family: Arial, sans-serif; font-size: 14px;"
                                        ...
                                        <a href="https://horus-health.com/" style="color: #ffffff;">Token de
                                            acceso
