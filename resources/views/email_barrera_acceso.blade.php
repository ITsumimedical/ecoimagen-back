                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td
                                        ...
                                        <p>Buen día,</p>
                                        <p>{{ $mensaje }}</p>
                                        <p><strong>Radicado:</strong> {{ $id }}</p>
                                        <p><strong>Tipo de barrera:</strong> {{ $tipo }}</p>
                                        <p><strong>Descripción:</strong> {{ $observacion }}</p>
                                        @if (!empty($observacion_cierre))
                                            <p><strong>Descripción Cierre:</strong> {{ $observacion_cierre }}</p>
                                        @endif
                                        @if (!empty($observacion_solucion))
                                            <p><strong>Descripción Solucion:</strong> {{ $observacion_solucion }}</p>
                                        @endif
                                        <p>Por favor, ingrese al módulo de Barreras de acceso para más detalles.</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                            ...
                                            <tr>
                                                <td width="260" valign="top">
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <p> <a href="https://sumi.horus-health.com/mesaAyuda/misAsignadas"
