				...
				<table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #cccccc; border-collapse: collapse;">
					<tr>
						<td align="center" bgcolor="#fff" style="padding: 40px 0 30px 0; color: #153643; font-size: 28px; font-weight: bold; font-family: Arial, sans-serif;">
							<img src="{{url('/images/logoFomag.png')}}" alt="" width="300" height="230" style="display: block;" />
						</td>
					</tr>
					<tr>
								...
								<tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                        @if($tipo == 'Comentario Publico')
                                            <p>Señor(a) {{ $name }} </p>
                                            <p>Lo invitamos a que ingrese en el siguiente enlace <a href="https://horus2.horus-health.com/">Gestión</a>.</p>
                                        ...
                                        @elseif($tipo == 'Respuesta')
                                            ...
                                            <p>Para ir a la solicitud click en el siguiente enlace <a href="https://horus2.horus-health.com/">Gestión</a>.</p>
                                            <p>Gracias por su atención</p>
                                        @endif
									</td>
								</tr>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td style="color: #ffffff; font-family: Arial, sans-serif; font-size: 14px;" width="75%">
										&reg; Fomag 2024<br/>
										<a href="https://horus2.horus-health.com/" style="color: #ffffff;">fomag.com<font color="#ffffff"></font></a>
									</td>
								</tr>
							</table>
						</td>
